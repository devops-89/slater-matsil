...
import HeroSection from "@/components/layouts/career-layout/Hero-section";
import WhyWorkWithus from "@/components/layouts/career-layout/Why-work-with-us";
import OpenRoles from "@/components/layouts/career-layout/Open-Roles";
...
export function CareersPagePreviews({ activeSection, websiteData }: any) {
