...
const PAGE_ITEMS = [
  ...
  { text: "Firm Professionals", icon: <Person fontSize="large" />, path: "/pages/firm-professionals", desc: "Manage Team Member profiles and bios." },
  { text: "Firm Leadership", icon: <Star fontSize="large" />, path: "/pages/firm-leadership", desc: "Update Leadership profiles and information." },
  { text: "Insights", icon: <Article fontSize="large" />, path: "/pages/insights", desc: "Edit Blog Posts and News articles." },
  { text: "Blogs", icon: <LibraryBooks fontSize="large" />, path: "/pages/blogs", desc: "Manage individual Blog Entries." },
  { text: "Careers", icon: <Work fontSize="large" />, path: "/pages/careers", desc: "Update job postings and career information." },
  { text: "Contact Us", icon: <ContactPhone fontSize="large" />, path: "/pages/contact-us", desc: "Update contact information and forms." },
